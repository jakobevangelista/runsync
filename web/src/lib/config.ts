...
const environmentSchema = z.object({
  ...
  RUNSYNC_SHARE_ID: optionalUUID,
  RUNSYNC_EMBED_ID: optionalUUID,
...
export function parseServerConfig(
  ...
  const values = fixtureMode
    ? {
        ...
        RUNSYNC_SHARE_ID: environment.RUNSYNC_SHARE_ID,
        RUNSYNC_EMBED_ID: environment.RUNSYNC_EMBED_ID,
  ...
  return {
    ...
    shareId: parsed.RUNSYNC_SHARE_ID ?? parsed.RUNSYNC_OVERLAY_ID,
    embedId: parsed.RUNSYNC_EMBED_ID ?? parsed.RUNSYNC_OVERLAY_ID,
