...
Durable retry and background-delivery recovery landed in
[PR #1](https://github.com/jakobevangelista/runsync/pull/1), transport
observability and the diagnostic server schema landed in
[PR #2](https://github.com/jakobevangelista/runsync/pull/2), and Connect IQ
transport recovery landed in
[PR #3](https://github.com/jakobevangelista/runsync/pull/3). The broader phased
plan remains the design and acceptance reference for work that has not yet
landed, including the remaining physical rollout and platform-limit
verification.
